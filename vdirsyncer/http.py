...
from aiohttp import ClientConnectionError, ServerDisconnectedError, ServerTimeoutError
...
class TransientNetworkError(exceptions.Error):
    """Raised for transient network conditions that should be retried."""

    pass


def _is_safe_to_retry_method(method: str) -> bool:
    """Return True if the HTTP method is safe/idempotent to retry.
